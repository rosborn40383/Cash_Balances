        ...
        for attachment in attachments:
            if attachment.FileName.lower().endswith(".xlsx"):
                ...
                if latest_attachment_date is None or message.ReceivedTime.date() > latest_attachment_date:
                    ...
                    folder_path = r"J:\Python\Cash Balances\Daily_Balances"
...
if not found_attachment or latest_attachment_path is None:
    ...
    extracted_data.sort(key=lambda x: x[3], reverse=True)

    # Define the folder and filename of the master Excel sheet
    master_folder_path = r"J:\Investments\Kim\eMars Account\FY24\Daily"
    master_filename = "March 2024 Daily Account Cash Balance.xlsx"
    ...
    backup_folder_path = r"J:\Python\Cash Balances\Backups"
